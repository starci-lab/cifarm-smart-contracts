...
const bigint_js_1 = require("../encoding/bigint.js");
...
class ABIAddressType extends ABIType {
    ...
    encode(value) {
        ...
        if (typeof value === 'string') {
            const decodedAddress = (0, address_js_1.decodeAddress)(value);
    ...
    decode(byteString) {
        ...
        return (0, address_js_1.encodeAddress)(byteString);
    }
}
...
class ABIStringType extends ABIType {
    ...
    encode(value) {
        ...
        const encodedLength = (0, bigint_js_1.bigIntToBytes)(encodedBytes.length, exports.LENGTH_ENCODE_BYTE_SIZE);
    ...
    decode(byteString) {
        ...
        const view = new DataView(byteString.buffer, byteString.byteOffset, exports.LENGTH_ENCODE_BYTE_SIZE);
...
class ABIArrayDynamicType extends ABIType {
    ...
    encode(value) {
        ...
        const encodedLength = (0, bigint_js_1.bigIntToBytes)(convertedTuple.childTypes.length, exports.LENGTH_ENCODE_BYTE_SIZE);
        const mergedBytes = (0, utils_js_1.concatArrays)(encodedLength, encodedTuple);
        return mergedBytes;
    }
    decode(byteString) {
        const view = new DataView(byteString.buffer, 0, exports.LENGTH_ENCODE_BYTE_SIZE);
        const byteLength = view.getUint16(0);
    ...
    encode(value) {
        ...
        while (i < tupleTypes.length) {
            ...
            if (tupleType.isDynamic()) {
                ...
                if (tupleType.constructor === ABIBoolType) {
                    ...
                    heads.push((0, bigint_js_1.bigIntToBytes)(compressedInt, 1));
                    i += after;
                }
                else {
        ...
        for (let j = 0; j < heads.length; j++) {
            if (isDynamicIndex.get(j)) {
                ...
                heads[j] = (0, bigint_js_1.bigIntToBytes)(headValue, exports.LENGTH_ENCODE_BYTE_SIZE);
            }
            tailLength += tails[j].length;
        }
        return (0, utils_js_1.concatArrays)(...heads, ...tails);
    }
    decode(byteString) {
        const tupleTypes = this.childTypes;
