...
const makeHealthCheck_js_1 = __importDefault(require("./makeHealthCheck.js"));
const lookupAssetBalances_js_1 = __importDefault(require("./lookupAssetBalances.js"));
const lookupAssetTransactions_js_1 = __importDefault(require("./lookupAssetTransactions.js"));
const lookupAccountTransactions_js_1 = __importDefault(require("./lookupAccountTransactions.js"));
const lookupBlock_js_1 = __importDefault(require("./lookupBlock.js"));
const lookupTransactionByID_js_1 = __importDefault(require("./lookupTransactionByID.js"));
const lookupAccountByID_js_1 = __importDefault(require("./lookupAccountByID.js"));
const lookupAccountAssets_js_1 = __importDefault(require("./lookupAccountAssets.js"));
const lookupAccountCreatedAssets_js_1 = __importDefault(require("./lookupAccountCreatedAssets.js"));
const lookupAccountAppLocalStates_js_1 = __importDefault(require("./lookupAccountAppLocalStates.js"));
const lookupAccountCreatedApplications_js_1 = __importDefault(require("./lookupAccountCreatedApplications.js"));
const lookupAssetByID_js_1 = __importDefault(require("./lookupAssetByID.js"));
const lookupApplications_js_1 = __importDefault(require("./lookupApplications.js"));
const lookupApplicationLogs_js_1 = __importDefault(require("./lookupApplicationLogs.js"));
const lookupApplicationBoxByIDandName_js_1 = __importDefault(require("./lookupApplicationBoxByIDandName.js"));
const searchAccounts_js_1 = __importDefault(require("./searchAccounts.js"));
const searchForTransactions_js_1 = __importDefault(require("./searchForTransactions.js"));
const searchForAssets_js_1 = __importDefault(require("./searchForAssets.js"));
const searchForApplications_js_1 = __importDefault(require("./searchForApplications.js"));
const searchForApplicationBoxes_js_1 = __importDefault(require("./searchForApplicationBoxes.js"));
/**
 ...
 */
class IndexerClient extends serviceClient_js_1.default {
    /**
     ...
     */
    makeHealthCheck() {
        return new makeHealthCheck_js_1.default(this.c);
    }
    /**
    ...
    lookupAssetBalances(index) {
        return new lookupAssetBalances_js_1.default(this.c, index);
    }
    /**
    ...
    lookupAssetTransactions(index) {
        return new lookupAssetTransactions_js_1.default(this.c, index);
    }
    /**
    ...
    lookupAccountTransactions(account) {
        return new lookupAccountTransactions_js_1.default(this.c, account);
    }
    /**
     ...
     */
    lookupBlock(round) {
        return new lookupBlock_js_1.default(this.c, round);
    }
    /**
    ...
    lookupTransactionByID(txID) {
        return new lookupTransactionByID_js_1.default(this.c, txID);
    }
    /**
    ...
    lookupAccountByID(account) {
        return new lookupAccountByID_js_1.default(this.c, account);
    }
    /**
    ...
    lookupAccountAssets(account) {
        return new lookupAccountAssets_js_1.default(this.c, account);
    }
    /**
    ...
    lookupAccountCreatedAssets(account) {
        return new lookupAccountCreatedAssets_js_1.default(this.c, account);
    }
    /**
    ...
    lookupAccountAppLocalStates(account) {
        return new lookupAccountAppLocalStates_js_1.default(this.c, account);
    }
    /**
    ...
    lookupAccountCreatedApplications(account) {
        return new lookupAccountCreatedApplications_js_1.default(this.c, account);
    }
    /**
    ...
    lookupAssetByID(index) {
        return new lookupAssetByID_js_1.default(this.c, index);
    }
    /**
    ...
    lookupApplications(index) {
        return new lookupApplications_js_1.default(this.c, index);
    }
    /**
    ...
    lookupApplicationLogs(appID) {
        return new lookupApplicationLogs_js_1.default(this.c, appID);
    }
    /**
     ...
     */
    searchAccounts() {
        return new searchAccounts_js_1.default(this.c);
    }
    /**
    ...
    searchForTransactions() {
        return new searchForTransactions_js_1.default(this.c);
    }
    /**
     ...
     */
    searchForAssets() {
        return new searchForAssets_js_1.default(this.c);
    }
    /**
    ...
    searchForApplications() {
        return new searchForApplications_js_1.default(this.c);
    }
    /**
     ...
     */
    searchForApplicationBoxes(appID) {
        return new searchForApplicationBoxes_js_1.default(this.c, appID);
    }
    /**
    ...
    lookupApplicationBoxByIDandName(appID, boxName) {
        return new lookupApplicationBoxByIDandName_js_1.default(this.c, appID, boxName);
    }
}
