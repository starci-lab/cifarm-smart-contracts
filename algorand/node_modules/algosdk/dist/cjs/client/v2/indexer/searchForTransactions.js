...
const lookupAccountTransactions_js_1 = require("./lookupAccountTransactions.js");
 ...
 * @category GET
 */
class SearchForTransactions extends jsonrequest_js_1.default {
    /**
     ...
     */
    notePrefix(prefix) {
        this.query['note-prefix'] = (0, lookupAccountTransactions_js_1.base64StringFunnel)(prefix);
        return this;
    }
    /**
    ...
    // eslint-disable-next-line class-methods-use-this
    prepare(response) {
        return (0, encoding_js_1.decodeJSON)(response.getJSONText(), types_js_1.TransactionsResponse);
    }
}
